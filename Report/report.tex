...
\begin{document}
	...
	\subsubsection{Tunnelling current}
		...
		\begin{figure}[H]
			...
			\label{fig:harmonic_oscillator_energy_measurement}
		\end{figure}
		For plots \ref{fig:harmonic_oscillator_energy_measurement1000} and \ref{fig:harmonic_oscillator_energy_measurement1000} the following parameters have been used: $i=1000$, $N=1000$, $\mu = -10$, $\tau = 0.1$, $\Delta x_{bin} = 0.1$, $\Delta d = 0.1$, with $\Delta x_{bin}$ and $\Delta d = 0.1$ being the size of the bins in position and distance direction respectively.
		For figures \ref{fig:harmonic_oscillator_energy_measurement10000} and \ref{fig:harmonic_oscillator_energy_measurement10000} the same parameter have been used, except for $i = 10000$ this time.
