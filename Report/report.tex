...
\begin{document}
	...
	\subsubsection{Tunnelling current}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=0.6\textwidth]{../imgs/anharmonic_oscillator_lambda_parameter/track_100001000_tunneling_current.pdf}
		...
		\end{figure}
		For plot \ref{fig:anharmonic_oscillator_tunneling_current} the following parameters have been used: $i=10000$, $\mu = -10$, $\Delta x_{bin} = 0.1$, $\Delta d = 0.1$, with $\Delta x_{bin}$ and $\Delta d = 0.1$ being the size of the bins in position and distance direction respectively.
