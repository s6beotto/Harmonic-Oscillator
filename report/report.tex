...
\begin{document}
	...
	\subsubsection{Classical limit}
		...
		\begin{figure}[H]
			\centering
				\includegraphics[width=0.5\textwidth]{../imgs/harmonic_oscillator_classical_limit/harmonic_oscillator_10_classical_limit.pdf}
		...
		\begin{figure}[H]
			\centering
				\includegraphics[width=0.5\textwidth]{../imgs/anharmonic_oscillator_classical_limit/anharmonic_oscillator_classical_limit.pdf}
	...
	\subsubsection{Tunnelling current}
		...
		The fit matches the data quite well, the characteristic length of the exponential function is \input{../imgs/anharmonic_oscillator_lambda_parameter/track_100001000_tunnelling_current_log_fit_slope.tex}\unskip.
