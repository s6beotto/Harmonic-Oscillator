...
\begin{document}
	...
	\section{Introduction}
		...
		These systems can thus be used to cross-check the validity of the used algorithms.
	...
	\subsection{Metropolis-Hastings algorithm}
		...
		To minimise these uncertainties, the largest values possible were used, while keeping the computation time within reasonable borders of around \SI{5}{\minute}.
	...
	\subsection{Fit}
		To fit perform fits of function to the data, the method of least squares is used.
